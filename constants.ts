...
export const PRODUCTS: Product[] = [
  {
    ...
    short_description: 'High-quality drywall gypsum screws with sharp points for easy penetration.',
    long_description: 'Our Drywall Screws are manufactured from Grade-1022 Mild Steel, ensuring durability and strength. They feature a bugle head (CSK Phillips) designed to sit flush with the drywall surface without tearing the paper. Suitable for fastening drywall to wood or metal studs.',
    source_page: 4,
  ...
  },
  {
    ...
    short_description: 'Corrosion-resistant stainless steel self-tapping screws for demanding environments.',
    long_description: 'Engineered from premium stainless steel (304/316), these screws offer superior corrosion resistance. Ideal for outdoor applications, marine environments, and food processing equipment where hygiene and durability are paramount.',
    source_page: 6,
  ...
  },
  {
    ...
    short_description: 'Standard machine screws for industrial machinery and automotive assembly.',
    long_description: 'Versatile machine screws available in M3 to M6 sizes. Manufactured from MS Grade-1008 with various head types including Slotted Cheese, Slotted CSK, Pan Combination, and Truss Head.',
    source_page: 12,
  ...
  },
  {
    ...
    short_description: 'Heavy-duty magnetic catches for cabinets and doors.',
    long_description: 'Reliable door magnets designed to keep cabinet doors and drawers securely closed. Made from high-quality Virgin PP and ABS plastic, available in multiple colors to match furniture aesthetics.',
    source_page: 17,
  ...
  },
  {
    ...
    short_description: 'Smooth-rolling caster wheels for furniture mobility.',
    long_description: 'Heavy-duty caster wheels with 12 Gauge (2.5mm) plate thickness. Provides smooth mobility for beds, tables, trolleys, and other furniture. Available in Orange, Black, and Blue.',
    source_page: 22,
    images: [IMG_CASTER],
    specifications: [
